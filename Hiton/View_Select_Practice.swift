...
class View_Select_Practice: UIView {
    ...
    let leftModeArray: [String] = ["Select_Practice_Left_CountUp", "Select_Practice_Left_BullShoot", "Select_Practice_Left_BigBull"]
    let rightModeArray: [String] = ["Select_Practice_Right_CountUp", "Select_Practice_Right_BullShoot", "Select_Practice_Right_BigBull"]
    
    let gameModeArray: [String] = ["Select_Practice_CountUp", "Select_Practice_BullShoot", "Select_Practice_BigBull"]
    
    let middleImageArray: [String] = ["GamePic_CountUp", "GamePic_BullShoot", "GamePic_BigBull"]
    ...
    func handleSwipes(sender:UISwipeGestureRecognizer) {
        ...
        if (sender.direction == .Left) {
            if selectMode == leftModeArray.count - 1{
                selectMode = 0
            }else{
                selectMode += 1
            }
        ...
        if (sender.direction == .Right) {
            if selectMode == 0{
                selectMode = leftModeArray.count - 1
            }else{
                selectMode -= 1
            }
            moveRight()
    ...
    func moveLeft(){
        removeSlideFunc()
        if selectMode == 0 {
            ImageView_Left.left_SlideLeft(UIImage(named: leftModeArray[leftModeArray.count - 1])!)
        }else{
            ImageView_Left.left_SlideLeft(UIImage(named: leftModeArray[selectMode - 1])!)
        }
        
        if selectMode == rightModeArray.count - 1 {
            ImageView_Right.right_SlideLeft(UIImage(named: rightModeArray[0])!)
        }else{
            ImageView_Right.right_SlideLeft(UIImage(named: rightModeArray[selectMode + 1])!)
        }
        GameViewAnimation()
    }
    ...
    func moveRight(){
        removeSlideFunc()
        if selectMode == 0 {
            ImageView_Left.left_SlideRight(UIImage(named: leftModeArray[leftModeArray.count - 1])!)
        }else{
            ImageView_Left.left_SlideRight(UIImage(named: leftModeArray[selectMode - 1])!)
        }
        
        if selectMode == rightModeArray.count - 1 {
            ImageView_Right.right_SlideRight(UIImage(named: rightModeArray[0])!)
        }else{
            ImageView_Right.right_SlideRight(UIImage(named: rightModeArray[selectMode + 1])!)
        }
        GameViewAnimation()
    }
