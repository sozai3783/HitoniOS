...
//
//  BullShooterViewController.swift
//  Hiton
//
...
class BullShooterViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
...
//        BigScore.drawMiddleScore(nowPlayer, _score: roundScore)
    ...
    func calScore(str: String){
        ...
        logic.Logic_BullShooter(str, _playerScore: roundScore) { (_score, _originalScore, _SDTBM, _status, _video) in
