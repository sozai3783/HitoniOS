...
class View_4P: UIView {
    ...
    @IBOutlet var P4_Photo: UIImageView!
    @IBOutlet var P4_Name: UILabel!
    @IBOutlet var P4_Label_PPD: UILabel!
    @IBOutlet var P4_Label_MRP: UILabel!
    @IBOutlet var P4_PPD: UILabel!
    @IBOutlet var P4_MRP: UILabel!
    @IBOutlet var P4_TTJ: UIButton!
    
    func setup(){
        
        self.performSelector(#selector(View_4P.setStyleCircleForImage(_:)), withObject: P1_Photo)
        self.performSelector(#selector(View_4P.setStyleCircleForImage(_:)), withObject: P2_Photo)
        self.performSelector(#selector(View_4P.setStyleCircleForImage(_:)), withObject: P3_Photo)
        self.performSelector(#selector(View_4P.setStyleCircleForImage(_:)), withObject: P4_Photo)
        P1_Photo.image = UIImage(named: "Guest")
        P2_Photo.image = UIImage(named: "Guest")
        P3_Photo.image = UIImage(named: "Guest")
        P4_Photo.image = UIImage(named: "Guest")
        ...
        P4_Label_PPD.hidden = true
        P4_Label_MRP.hidden = true
        P4_PPD.hidden = true
        P4_MRP.hidden = true
    ...
    @IBAction func P4TTJPressed(sender: AnyObject) {
    }
