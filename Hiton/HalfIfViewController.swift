//
//  HalfIfViewController.swift
//  Hiton
//
//  Created by yao on 02/08/2016.
//  Copyright © 2016 apsystem. All rights reserved.
//

import UIKit

class HalfIfViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {

    @IBOutlet var ImageView_Smile: UIImageView!
    @IBOutlet var ImageView_ThrowAt: UIImageView!
    ...
    func setupView(){
        ...
        HalfCut = NSBundle.mainBundle().loadNibNamed("HalfIf_Cut", owner: self, options: nil).last as? HalfIf_Cut
        HalfCut!.frame = self.view.bounds
        HalfCut?.setup()
    }
    ...
    func ThrowAt(){
        switch round {
        case 1:
            ImageView_ThrowAt.image = UIImage(named: "Throw at 15")
            break
        case 2:
            ImageView_ThrowAt.image = UIImage(named: "Throw at 16")
            break
        case 3:
            ImageView_ThrowAt.image = UIImage(named: "Throw at Any Double")
            break
        case 4:
            ImageView_ThrowAt.image = UIImage(named: "Throw at 17")
            break
        case 5:
            ImageView_ThrowAt.image = UIImage(named: "Throw at 18")
            break
        case 6:
            ImageView_ThrowAt.image = UIImage(named: "Throw at Any Triple")
            break
        case 7:
            ImageView_ThrowAt.image = UIImage(named: "Throw at 19")
            break
        case 8:
            ImageView_ThrowAt.image = UIImage(named: "Throw at 20")
            break
        case 9:
            ImageView_ThrowAt.image = UIImage(named: "Throw at bull")
            break
        default:
            break
        }
        ...
        if indexPath.row + 1 < round{
            ...
            case 1:
                if P1.RoundTotalScoreArray.count != 0 {
                    if P1.RoundTotalScoreArray.objectAtIndex(indexPath.row) as! Int == 0 {
                        cell.RoundScore.drawHalf()
                    }else {
            ...
            case 2:
                if P2.RoundTotalScoreArray.count != 0 {
                    if P2.RoundTotalScoreArray.objectAtIndex(indexPath.row) as! Int == 0 {
                        cell.RoundScore.drawHalf()
                    }else {
            ...
            case 3:
                if P3.RoundTotalScoreArray.count != 0 {
                    if P3.RoundTotalScoreArray.objectAtIndex(indexPath.row) as! Int == 0 {
                        cell.RoundScore.drawHalf()
                    }else {
            ...
            case 4:
                if P4.RoundTotalScoreArray.count != 0 {
                    if P4.RoundTotalScoreArray.objectAtIndex(indexPath.row) as! Int == 0 {
                        cell.RoundScore.drawHalf()
                    }else {
    ...
    func drawScore(_round: Int, _nPlayer: Int,_dart: Int, _SDTBM: String, _originalScore: Int){
        ...
        case 1:
            ...
            if _SDTBM == "D-Bull" || _SDTBM == "S-Bull"{
                self.drawList(50, _originalScore: _originalScore, _SDTM: _SDTBM)
            }else if _SDTBM == "Triple"{
                self.drawList(_originalScore * 3, _originalScore: _originalScore, _SDTM: _SDTBM)
            }else if _SDTBM == "Double"{
                self.drawList(_originalScore * 2, _originalScore: _originalScore, _SDTM: _SDTBM)
            }else if _SDTBM == "Miss"{
                self.drawList(0, _originalScore: _originalScore, _SDTM: _SDTBM)
            }else{
                self.drawList(_originalScore, _originalScore: _originalScore, _SDTM: _SDTBM)
            }
            break
        case 2:
            self.drawDartScore(self.dartsHit, _SDTBM: _SDTBM, _originalScore: _originalScore)
    ...
    func drawList(_score: Int, _originalScore: Int, _SDTM: String){
        ...
        ThisRoundScoreArray.addObject(tempScore)//asd
    ...
    func calScore(str: String){
        ...
        logic.Logic_HalfIf(str, _round: round, _playerScore: roundScore) { (_score, _originalScore, _SDTBM, _status, _bust, _smile) in
            if _bust == 1 {
                self.isBust = true
                self.view.addSubview(self.HalfCut!)
                self.audio.CutPlay()
                self.HalfCut?.animation()
            }
            
            if _smile == true {
                self.audio.SmilePlay()
                self.ImageView_Smile.Smile_Play()
            }
