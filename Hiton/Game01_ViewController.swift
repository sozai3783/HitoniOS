...
class Game01_ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    var bluetoothDic: Pop_BluetoothDisconnect!
    ...
    override func viewDidLoad() {
        ...
        bluetoothDic = NSBundle.mainBundle().loadNibNamed("Pop_BluetoothDisconnect", owner: self, options: nil).last as? Pop_BluetoothDisconnect
        bluetoothDic!.frame = self.view.bounds
        bluetoothDic.OK = {
            Void in
           self.goMenu()
        }
        ...
        bluetooth.disconnect = {
            self.view.addSubview(self.bluetoothDic)
        }
    ...
    func calScore(str: String){
        ...
        logic.Game_01_Logic(roundScore, hitScore: str, _p: tempPlayer) { (_score, _originalScore, _SDTBM, _status, _video) in
