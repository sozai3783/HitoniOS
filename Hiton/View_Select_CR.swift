...
class View_Select_CR: UIView {
    ...
    let left01ModeArray: [String] = ["CR_Left_Standard", "CR_Left_CT", "CR_Left_Random", "CR_Left_RandomCT"]
    let right01ModeArray: [String] = ["CR_Right_Standard", "CR_Right_CT", "CR_Right_Random", "CR_Right_RandomCT"]
    
    //let gameModeArray: [String] = ["CR_Standard", "CR_CT", "CR_Random", "CR_RandomCT"]
    let gameModeArray: [String] = ["Select_CR_Standard", "Select_CR_CT", "Select_CR_Hidden", "Select_CR_Random"]
