...
class View_Select_Fun: UIView {
    ...
    let leftModeArray: [String] = ["Select_Fun_Left_HalfIf", "Select_Fun_Left_LuckyBalloon"]
    let rightModeArray: [String] = ["Select_Fun_Right_HalfIf", "Select_Fun_Right_LuckyBalloon"]
    
    let gameModeArray: [String] = ["Select_Fun_HalfIf", "Select_Fun_LuckyBalloon"]
    
    let middleImageArray: [String] = ["GamePic_HalfIf", "GamePic_LuckyBalloon"]
