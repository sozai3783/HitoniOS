...
//
//  BigBullViewController.swift
//  Hiton
//
//  Created by yao on 08/08/2016.
//  Copyright © 2016 apsystem. All rights reserved.
//

import UIKit

class BigBullViewController: UIViewController, UITableViewDelegate, UITableViewDataSource  {
    ...
    func drawScore(_round: Int, _nPlayer: Int,_dart: Int, _SDTBM: String, _originalScore: Int){
        ...
        case 1:
            ...
            if _SDTBM == "D-Bull" || _SDTBM == "S-Bull"{
                ...
                let tempInt = _SDTBM == "Single" ? 1 : _SDTBM == "Double" ? 2 : 3
                self.drawList(_originalScore * tempInt)
            }else{
                self.drawList(0)
            }
            break
        case 2:
            ...
            self.drawDartScore(self.dartsHit, _SDTBM: _SDTBM, _originalScore: _originalScore)
            if _SDTBM == "D-Bull" || _SDTBM == "S-Bull" || _SDTBM == "Small"{
//                if _SDTBM == "D-Bull"{
//                    self.drawList(100)
//                }else if _SDTBM == "S-Bull"{
//                    self.drawList(75)
...
//                }
    ...
    func calScore(str: String){
        ...
        logic.Logic_BigBull(str, _playerScore: roundScore) { (_score, _originalScore, _SDTBM, _status, _video) in
            ...
            if _originalScore == 50 || _originalScore == 75 {
                self.drawScore(self.round, _nPlayer: self.nowPlayer, _dart: self.dartsHit, _SDTBM: "S-Bull", _originalScore: _originalScore)
            }else if _originalScore == 100 {
                self.drawScore(self.round, _nPlayer: self.nowPlayer, _dart: self.dartsHit, _SDTBM: "D-Bull", _originalScore: _originalScore)
            }else {
